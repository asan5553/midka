...
class Schedule(models.Model):
    id_wk = models.ForeignKey('Weekday1', models.DO_NOTHING, db_column='id_wk', blank=True, null=True)
    id_lesson = models.ForeignKey(Lesson, models.DO_NOTHING, db_column='id_lesson', blank=True, null=True)
